...
export const leaseAlerts: LeaseAlert[] = [
  {
    ...
    propertyName: '南京復興館',
    roomCode: 'B3',
    leaseStart: new Date('2025-03-30'),
    leaseEnd: new Date('2026-03-29'),
    monthlyRent: 21500,
    status: 'expiringSoon',
    alertSent: false,
  ...
  },
  {
    ...
    propertyName: '中山北路館',
    roomCode: 'A8',
    leaseStart: new Date('2025-04-09'),
    leaseEnd: new Date('2026-04-08'),
    monthlyRent: 19800,
    status: 'active',
    alertSent: false,
  ...
  },
  {
    ...
    propertyName: '古亭捷運館',
    roomCode: 'C4',
    leaseStart: new Date('2025-04-16'),
    leaseEnd: new Date('2026-04-15'),
    monthlyRent: 22800,
    status: 'active',
    alertSent: false,
